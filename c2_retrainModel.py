...
if __name__ == '__main__':
  ...
  parser.add_argument(
      ...
      default='D:/TOMTOM/MAGICscan/datatemp',
  ...
  parser.add_argument(
      ...
      type=str,
      default='D:/TOMTOM/MAGICscan/model_magicV1/intermediate_graph/',
  ...
  parser.add_argument(
      '--summaries_dir',
      type=str,
      default='D:/TOMTOM/MAGICscan/model_magicV1/retrain_logs',
  ...
  parser.add_argument(
      '--model_dir',
      type=str,
      default='D:/TOMTOM/MAGICscan/model_magicV1/imagenet',
      help="""\
  ...
  parser.add_argument(
      '--bottleneck_dir',
      type=str,
      default='D:/TOMTOM/MAGICscan/model_magicV1/bottleneck',
